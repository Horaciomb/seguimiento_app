...
function DialogFooter({ className, children, ...props }) {
  return (
    <div
      ...
      className={cn(
        "sticky bottom-[-1rem] -mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-2xl border-t bg-muted/50 p-4 supports-backdrop-filter:backdrop-blur-sm sm:flex-row sm:justify-end",
        className
      )}
      {...props}>
      {children}
